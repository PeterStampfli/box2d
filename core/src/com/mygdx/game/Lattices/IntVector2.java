...
public class IntVector2 {
    ...
    /**
     * Constructs a vector with the given int components
     *
    ...
    /**
     * Constructs a vector with the given rounded float components
     *
    ...
    /**
     * Constructs a vector from the given vector2
     *
     * @param v The vector
     */
    ...
    /**
     * Sets this vector from rounding the given vector2
     *
     * @param v The vector2
     * @return This vector for chaining
     */
    public IntVector2 set(Vector2 v) {
        x = Math.round(v.x);
        y = Math.round(v.y);
        return this;
    }
     ...
     *
     * @param x int, The x-component
     * @param y int, The y-component
     * @return This vector for chaining
     */
    ...
    /**
     * Sets the components of this vector rounding floats
     *
     * @param x float, The x-component
     * @param y float, The y-component
     * @return This vector for chaining
    ...
    /**
     * sets the components of a vector2 to the values of this vector
     *
     * @param vector2 Vector2, will be set to have the value of this vector
     * @return This vector for chaining
     */
    public IntVector2 asVector2(Vector2 vector2) {
        vector2.set(x, y);
        return this;
    }

    /**
     * @return Vector2 with components of this vector
     */
